...
namespace Ossama.BELMASROUR.ObjectDetection
{
    public class Yolo
    {
        // Exemple de méthode de détection (à adapter selon votre cas)
        public IList<BoundingBox> Detect(byte[] imageData)
        {
            // Retourne un résultat fictif (Mock) pour éviter les erreurs
...
public class YoloOutput
{
    ...
    public object Select(Func<object, Ossama.BELMASROUR.ObjectDetection.BoundingBox> func)
    {
